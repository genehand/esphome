#include "epaper_ssd1683_waveshare.h"

#include "esphome/core/log.h"

namespace esphome::epaper_spi {

static constexpr const char *const TAG = "epaper_spi.ssd1683_waveshare";
 ...
 */
void HOT EPaperSSD1683Waveshare::draw_pixel_at(int x, int y, Color color) {
...
void EPaperSSD1683Waveshare::fill(Color color) {
  if (this->display_mode_ != SSD1683DisplayMode::GRAYSCALE4) {
...
void EPaperSSD1683Waveshare::clear() {
  if (this->display_mode_ != SSD1683DisplayMode::GRAYSCALE4) {
    EPaperMono::clear();
    return;
  }
 ...
 *   [232]      → 0x2C  VCOM level
 */
void EPaperSSD1683Waveshare::send_gray_lut_() {
...
void EPaperSSD1683Waveshare::set_full_window_() {
...
void EPaperSSD1683Waveshare::set_window() {
...
void EPaperSSD1683Waveshare::setup() {
...
bool EPaperSSD1683Waveshare::initialise(bool partial) {
  if (this->display_mode_ != SSD1683DisplayMode::GRAYSCALE4) {
...
bool HOT EPaperSSD1683Waveshare::transfer_data_fast_() {
...
bool HOT EPaperSSD1683Waveshare::transfer_data_partial_() {
...
bool HOT EPaperSSD1683Waveshare::transfer_data() {
  if (this->display_mode_ == SSD1683DisplayMode::FAST ||
...
void EPaperSSD1683Waveshare::refresh_screen(bool partial) {
  if (this->display_mode_ == SSD1683DisplayMode::FAST) {
