...
class SSD1683(EpaperModel):
    """Base model for Solomon SSD1683 e-paper displays."""
...
class SSD1683WaveshareModel(EpaperModel):
    """
    Model class for SSD1683 e-paper displays using the Waveshare V2 driver.

    Accepts a 233-byte grayscale LUT used in GRAYSCALE4 display mode.
    Also supports a ``display_mode`` config option.
    """

    def __init__(self, name, gray_lut, class_name="EPaperSSD1683Waveshare", **defaults):
        super().__init__(name, class_name, **defaults)
